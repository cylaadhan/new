      ...
      <main className="flex-1 p-8 bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <div className="space-y-2 mt-2">
              <div className="flex items-center gap-4">
                <span className="text-gray-800 w-32 text-sm">Regular</span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="max-w-[70%] w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-1 bg-blue-500 rounded-full" style={{ width: '60%' }}></div>
                  </div>
                  <span className="text-gray-800 text-sm w-6 text-right">6</span>
                  <span className="text-gray-500 text-sm min-w-[90px] text-right">(Rp 600.000)</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-gray-800 w-32 text-sm">VIP</span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="max-w-[70%] w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-1 bg-blue-400 rounded-full" style={{ width: '60%' }}></div>
                  </div>
                  <span className="text-gray-800 text-sm w-6 text-right">6</span>
                  <span className="text-gray-500 text-sm min-w-[90px] text-right">(Rp 900.000)</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-gray-800 w-32 text-sm">Premium</span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="max-w-[70%] w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                  ...
                  <span className="text-gray-500 text-sm min-w-[90px] text-right">(Rp 200.000)</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <div className="space-y-2 mt-2">
              <div className="flex items-center gap-4">
                <span className="text-gray-800 w-32 text-sm">Lunas</span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="max-w-[70%] w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-1 bg-green-500 rounded-full" style={{ width: '75%' }}></div>
                  </div>
                  <span className="text-gray-800 text-sm w-6 text-right">9</span>
                  <span className="text-gray-500 text-sm min-w-[90px] text-right">(Rp 1.050.000)</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-gray-800 w-32 text-sm">Menunggu</span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="max-w-[70%] w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                  ...
                  <span className="text-gray-500 text-sm min-w-[90px] text-right">(Rp 500.000)</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-gray-800 w-32 text-sm">Dibatalkan</span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="max-w-[70%] w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-1 bg-gray-300 rounded-full" style={{ width: '0%' }}></div>
                  </div>
                  <span className="text-gray-800 text-sm w-6 text-right">0</span>
                  <span className="text-gray-500 text-sm min-w-[90px] text-right">(Rp 0)</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-gray-800 w-32 text-sm">Digunakan</span>
                <div className="flex-1 flex items-center gap-2">
                  <div className="max-w-[70%] w-full h-1 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-1 bg-gray-700 rounded-full" style={{ width: '10%' }}></div>
                  </div>
                  <span className="text-gray-800 text-sm w-6 text-right">1</span>
                  <span className="text-gray-500 text-sm min-w-[90px] text-right">(Rp 150.000)</span>
                </div>
              </div>
            </div>
          </div>
