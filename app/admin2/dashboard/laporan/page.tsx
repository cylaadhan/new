...
export default function Page() {
  ...
  const ticketTypeData = [
    { type: "Early Bird", ...(breakdownType['Early Bird'] || { count: 0, amount: 0 }), color: "bg-blue-500" },
    { type: "Presale 1", ...(breakdownType['Presale 1'] || { count: 0, amount: 0 }), color: "bg-blue-400" },
    { type: "Presale 2", ...(breakdownType['Presale 2'] || { count: 0, amount: 0 }), color: "bg-purple-400" },
    { type: "Presale 3", ...(breakdownType['Presale 3'] || { count: 0, amount: 0 }), color: "bg-orange-400" },
