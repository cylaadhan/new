          ...
          {isMobile && (
            <div className="mb-6">
              ...
              <div className="flex items-center justify-between mt-3">
                <p className="text-gray-500 text-sm">Selamat Datang di Dashboard Admin</p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 flex justify-between items-center hover:shadow-xl transition-shadow duration-300">
                <div>
                  <p className="text-gray-500 text-sm md:text-base">Total Tiket</p>
                  <p className="text-2xl md:text-4xl font-bold text-gray-900">13</p>
                </div>
                <div className="bg-blue-500 text-white p-3 md:p-4 rounded-lg">
                  <Ticket className="h-5 w-5 md:h-7 md:w-7" />
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 flex justify-between items-center hover:shadow-xl transition-shadow duration-300">
                <div>
                  ...
                  <p className="text-2xl md:text-4xl font-bold text-gray-900">Rp 1.050.000</p>
                </div>
            ...
            {/* Bottom Content Area - Responsive */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
